...
const OFFICES = [
  {
    ...
    flag: '🇦🇪',
    addressAr: 'دبي إنفستمنت بارك 23، أبو شغارة، الشارقة',
    addressEn: 'Dubai Investment Park 23, Abu Shagara, Sharjah',
    phone: '+971 54 362 22 88',
    whatsapp: '+971 54 362 22 88',
    ...
    mapEmbed: 'https://maps.google.com/?q=' + encodeURIComponent('Dubai Investment Park 23 Abu Shagara Sharjah'),
  },
  {
    cityAr: 'بورصة',
    cityEn: 'Bursa',
    ...
    countryEn: 'Türkiye',
    flag: '🇹🇷',
    addressAr: 'حي أوتشِفلر، شارع إزمير يولو، زقاق آيسيل رقم 5، مركز سرتيبه للأعمال، الطابق 5 مكتب 18، نيلوفر/بورصة 16120',
    addressEn: 'Üçevler Mahallesi, İzmir Yolu Caddesi, Aysel Sokak No:5, Sertepe İş Merkezi Kat 5 Ofis 18, 16120 Nilüfer/Bursa',
    phone: '+90 530 789 18 43',
    whatsapp: '+90 530 789 18 43',
    email: 'info@almiftahrealestate.com',
    hoursAr: 'الاثنين – السبت: 9:00 – 19:00',
    hoursEn: 'Monday – Saturday: 9:00 – 19:00',
    photo: 'https://upload.wikimedia.org/wikipedia/commons/7/72/Sunset_in_Bursa.jpg',
    mapEmbed: 'https://maps.google.com/?q=' + encodeURIComponent('Üçevler Mahallesi İzmir Yolu Caddesi Aysel Sokak No:5 Sertepe İş Merkezi Nilüfer Bursa'),
  },
];
