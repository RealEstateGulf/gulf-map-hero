...
const STEPS = [
  { num: '01', titleAr: 'اختيار العقار المناسب', titleEn: 'Selecting the Right Property', descAr: 'يجب أن تكون قيمة العقار 400,000 دولار أمريكي على الأقل، وأن يتم تسجيله باسم المستثمر في الطابو (سند الملكية التركي).  نساعدك في اختيار العقار المناسب من محفظتنا الحصرية.', descEn: "The property's value must be at least USD 400,000, and it must be registered with the Land Department (TKGM). We can help select the right property from our exclusive and private portfolio.", durationAr: 'أسبوعان', durationEn: '2 weeks' },
  { num: '02', titleAr: 'إعداد الملف وتقديم الطلب', titleEn: 'Document Preparation & Application Submission', descAr: 'نقوم بإعداد جميع وثائق طلب الجنسية: تقرير التقييم العقاري، الترجمات المعتمدة، إثباتات الدفع، والسجل العدلي . ثم يتم تقديم طلب الحصول على الجنسية من خلال مكتبنا القانوني المرخص.', descEn: 'We prepare all the documents required for the citizenship application, such as the real estate valuation report, certified translations, proof of payment, and the criminal record certificate. We submit the application through our licensed legal office.', durationAr: '3-5 أيام', durationEn: '3-5 days' },
  { num: '03', titleAr: 'الموافقة واستلام جواز السفر', titleEn: 'Approval & Passport Delivery', descAr: 'تستغرق العملية عادةً من 3 إلى 6 أشهر. بعد الموافقة، تقدم الجنسية التركية وجواز السفر التركي لك و لعائلتك (الزوج/الزوجة والأولاد دون سن 18 عاماً).', descEn: 'Usually, the process takes 3 to 6 months. After the approval, you and your family (spouse and children under 18) can obtain Turkish citizenship and Turkish passports.', durationAr: '1-3 أسابيع', durationEn: '1-3 weeks' },
...
export default function CitizenshipClient() {
  const { t } = useTheme();
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontFamily: "'Marcellus', serif", color: '#fff', fontSize: isMobile ? 'clamp(1.9rem,7vw,2.8rem)' : 'clamp(2.6rem,4.5vw,4rem)', lineHeight: 1.2, marginBottom: 20, position: 'relative' }}>
        ...
        <br />
        <em style={{ color: t.gold }}>{get('hero.subtitle', isAr, isAr ? 'جواز سفر قوي يفتح لك الأبواب لأكثر من 110 دولة — من خلال استثمار عقاري آمن' : 'A powerful passport that opens the door to more than 110 countries — through a guaranteed real estate investment.')}</em>
      </h1>
