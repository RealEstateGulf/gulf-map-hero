...
const PAGE_FIELDS: Record<string, FieldDef[]> = {
  home: [
    ...
    { key: 'hero.sub',       label: 'Hero Alt Başlık',             type: 'textarea', defaultAr: 'فرص استثمارية فاخرة في قلب إسطنبول وأبرز المدن التركية', defaultEn: "Luxury investment opportunities in the heart of Istanbul and Türkiye's top cities" },
    ...
    { key: 'why.title',      label: 'Neden Türkiye Başlığı',       type: 'text',     defaultAr: 'لماذا تركيا؟',                       defaultEn: 'Why Türkiye?' },
  ...
  services: [
    ...
    { key: 'hero.subtitle', label: 'Alt Başlık',        type: 'text',     defaultAr: 'كل ما تحتاجه لاستثمار ناجح في تركيا',          defaultEn: 'Everything you need for a successful investment in Türkiye' },
    { key: 'hero.image',    label: 'Hero Görseli',      type: 'image' },
  ...
  turkey: [
    { key: 'hero.title',    label: 'Sayfa Başlığı',    type: 'text',     defaultAr: 'لماذا تركيا؟',                        defaultEn: 'Why Türkiye?' },
